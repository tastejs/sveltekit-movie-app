...
var init_layout_938abee5 = __esm({
  ".svelte-kit/output/server/chunks/__layout-938abee5.js"() {
    ...
    Genre = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
async function load6({ fetch: fetch2, page: page2 }) {
  const res = await fetch2("../../api/getSeason", {
    headers: { "Content-Type": "application/json" },
    method: "POST",
    body: JSON.stringify({
      id: page2.params.id,
...
<section id="${"season"}"><div class="${"max-w-7xl mx-auto text-skin-base xl:mt-5 xl:mb-10 bg-skin-secondary xl:pl-5 pt-1 pb-1 xl:rounded-2xl"}">${season_details.id ? `<h4 class="${"pb-2"}">Season Information</h4>
			${each(season_details.episodes, (episode) => `<div class="${"bg-skin-primary flex flex-col xl:flex-row m-4 p-2 rounded-lg"}"><a${add_attribute("href", `/episode/${tv_id}/${season_details.season_number}/${episode.episode_number}`, 0)} class="${"flex flex-col xl:flex-row text-skin-base xl:rounded-lg"}"><div class="${"flex mx-auto max-h-full max-w-full xl:m-0 xl:flex-none xl:w-80 xl:h-44 xl:items-start"}"><img class="${"flex xl:w-80 xl:h-44 items-start"}"${add_attribute("src", episode.still_path ? IMAGE_API3 + episode.still_path : "/default.jpg", 0)} alt="${"season"}"></div>
    ...
    U5Bseason_numberu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ".svelte-kit/output/server/chunks/[id]-8c40f23a.js"() {
    ...
    KnownFor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<section id="${"known-for"}" class="${"grid mx-auto"}">${films ? `<h3 class="${"flex xl:inline-block justify-center xl:justify-start xl:my-5 text-2xl font-bold"}">Movies
			...
			<div class="${"text-skin-base flex flex-wrap justify-center sm:justify-start sm:flex-nowrap sm:overflow-y-hidden relative"}">${each(films, (movie) => `<div class="${"w-28 h-56 flex-shrink-0 rounded mb-2 relative bg-secondary m-0.5 sm:mr-3 hover:bg-selected"}"><a class="${"rounded w-28"}"${add_attribute("href", `/movie/${movie.id}`, 0)}><img class="${"object-cover w-28 h-44 rounded-t"}"${add_attribute("src", movie.poster_path ? IMAGE_API$12 + movie.poster_path : "/default.jpg", 0)}${add_attribute("alt", movie.title, 0)}>
		...
		${tv ? `<h3 class="${"flex xl:inline-block justify-center xl:justify-start xl:my-5 text-2xl font-bold"}">TV
			...
			<div class="${"flex flex-wrap justify-center sm:justify-start sm:flex-nowrap sm:overflow-y-hidden relative"}">${each(tv, (show) => `<div class="${"w-28 h-56 flex-shrink-0 rounded mb-2 relative bg-secondary m-0.5 sm:mr-3 hover:bg-selected"}"><a class="${"rounded w-28"}"${add_attribute("href", `/tv/${show.id}`, 0)}><img class="${"object-cover w-28 h-44 rounded-t"}"${add_attribute("src", show.poster_path ? IMAGE_API$12 + show.poster_path : "/default.jpg", 0)}${add_attribute("alt", show.name, 0)}>
    ...
    IMAGE_API4 = "https://image.tmdb.org/t/p/w500/";
    Person = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.knownFor === void 0 && $$bindings.knownFor && knownFor !== void 0)
        $$bindings.knownFor(knownFor);
      return `<section id="${"person"}" class="${"xl:rounded-2xl mx-auto max-w-7xl xl:pb-20 xl:mt-5"}"><div class="${"grid xl:grid-cols-5 xl:grid-rows-auto xl:auto-rows-fr"}"><div class="${"xl:rounded-2xl bg-skin-secondary w-full xl:p-2 xl:col-start-1 xl:col-end-2 xl:row-start-1 xl:row-end-3 mx-auto"}">${person.profile_path ? `<img class="${"mt-4 xl:mt-0 xl:pt-0 w-64 h-96 rounded-2xl mx-auto"}"${add_attribute("src", IMAGE_API4 + person.profile_path, 0)} alt="${"profile"}">` : `<img class="${"mt-4 xl:pt-0 flex justify-end w-64 h-96 rounded-2xl mx-auto"}" src="${"/person.svg"}" alt="${"profile"}">`}
...
async function load8({ fetch: fetch2, page: page2 }) {
  const res = await fetch2("../api/getSearch", {
    headers: { "Content-Type": "application/json" },
    method: "POST",
    body: JSON.stringify({
      media: get_store_value(media_type),
      page: "1",
      query: page2.params.id
    })
  });
  const datas = await res.json();
  data.set(await datas.res.results);
...
var init_Cast_31f4e4f3 = __esm({
  ".svelte-kit/output/server/chunks/Cast-31f4e4f3.js"() {
    ...
    IMAGE_API5 = "https://image.tmdb.org/t/p/w200/";
    Cast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { cast = [] } = $$props;
...
var init_id_de8563ca = __esm({
  ".svelte-kit/output/server/chunks/[id]-de8563ca.js"() {
    ...
    MovieMedia = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `${movie_details.id && trailer_id ? `<section id="${"media"}" class="${"text-skin-inverted xl:mt-5 bg-no-repeat bg-right-top bg-contain xl:bg-cover xl:rounded-2xl"}" style="${"background-image: url(" + escape(IMAGE_API6) + "original/" + escape(movie_details.backdrop_path) + ")"}"><div class="${"bg-gradient-to-r xl:rounded-2xl"}" style="${"background-image: linear-gradient(to right, rgb(5, 69, 112) 150px, rgba(37, 137, 204, 0.84) 100%)"}"><div class="${"grid max-w-7xl xl:grid-cols-4 px-10 py-8 mx-auto xl:rounded-2xl"}"><div class="${"col-start-1 col-end-2 "}"><img class="${"h-96 w-64 xl:h-120 xl:w-80 overflow-hidden rounded-2xl mx-auto"}"${add_attribute("src", movie_details.poster_path ? IMAGE_API6 + "w500" + movie_details.poster_path : "/default.jpg", 0)} alt="${"movie poster"}"></div>
  ...
  ".svelte-kit/output/server/chunks/[id]-a8c2d94e.js"() {
    ...
    Seasons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<section id="${"Seasons"}"><div class="${"max-w-7xl mx-auto text-skin-base xl:mt-5 xl:mb-10 bg-skin-secondary xl:pl-5 pt-1 pb-1 xl:rounded-2xl"}"><h4 class="${"pb-2"}">Season Information</h4>
		${each(tv_details.seasons, (episode) => `<div class="${"bg-skin-primary flex flex-col xl:flex-row m-4 p-2 rounded-lg"}"><a${add_attribute("href", `/seasons/${movie_id}/${episode.season_number}`, 0)} class="${"flex flex-col xl:flex-row text-skin-base xl:rounded-lg"}"><div class="${"flex mx-auto max-h-full max-w-full xl:m-0 xl:flex-none xl:w-40 xl:h-60 xl:items-start"}"><img class="${"flex xl:w-40 xl: h-60 items-start"}"${add_attribute("src", episode.poster_path ? IMAGE_API$13 + episode.poster_path : "/default.jpg", 0)} alt="${"episode"}"></div>
    ...
    IMAGE_API7 = "https://image.tmdb.org/t/p/";
    TvMedia = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `${tv_details.id && trailer_id ? `<section id="${"media"}" class="${"text-skin-inverted xl:mt-5 bg-no-repeat bg-right-top bg-contain xl:bg-cover xl:rounded-2xl"}" style="${"background-image: url(" + escape(IMAGE_API7) + "original/" + escape(tv_details.backdrop_path) + ")"}"><div class="${"bg-gradient-to-r xl:rounded-2xl"}" style="${"background-image: linear-gradient(to right, rgb(5, 69, 112) 150px, rgba(37, 137, 204, 0.84) 100%)"}"><div class="${"grid max-w-7xl xl:grid-cols-4 px-10 py-8 mx-auto xl:rounded-2xl"}"><div class="${"col-start-1 col-end-2 "}"><img class="${"h-96 w-64 xl:h-120 xl:w-80 overflow-hidden rounded-2xl mx-auto"}"${add_attribute("src", tv_details.poster_path ? IMAGE_API7 + "w500" + tv_details.poster_path : "/default.jpg", 0)} alt="${"movie poster"}"></div>
    ...
    manifest = {
      ...
      routes: [
        ...
        },
        {
          ...
          params: empty,
          load: () => Promise.resolve().then(() => (init_getMovieGenres_3625ddfd(), getMovieGenres_3625ddfd_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getTvNetworks\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getTvNetworks_3869faf2(), getTvNetworks_3869faf2_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getShowGenre\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getShowGenre_bece8541(), getShowGenre_bece8541_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getKnownFor\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getKnownFor_737a4ce8(), getKnownFor_737a4ce8_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getTvGenres\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getTvGenres_8924ea77(), getTvGenres_8924ea77_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getEpisode\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getEpisode_3741fea8(), getEpisode_3741fea8_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getTrailer\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getTrailer_b36b5a94(), getTrailer_b36b5a94_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getPerson\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getPerson_73622a35(), getPerson_73622a35_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getSearch\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getSearch_b70547a7(), getSearch_b70547a7_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getSeason\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getSeason_d3cb4046(), getSeason_d3cb4046_exports))
        },
        {
          type: "endpoint",
        ...
        },
        {
          ...
          pattern: /^\/api\/getCast\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getCast_7cf0533a(), getCast_7cf0533a_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/api\/getShow\/?$/,
          params: empty,
          load: () => Promise.resolve().then(() => (init_getShow_6a79cddc(), getShow_6a79cddc_exports))
        },
        {
          type: "page",
          pattern: /^\/tv\/([^/]+?)\/?$/,
