...
<section id='person' class='rounded-2xl mx-auto max-w-7xl xl:pb-20 xl:mt-5'>
  <div class=' grid xl:grid-cols-5 xl:grid-rows-auto xl:auto-rows-fr' > 
    <div class='rounded-2xl bg-skin-secondary w-full xl:p-2 xl:col-start-1 xl:col-end-2 xl:row-start-1 xl:row-end-3 mx-auto'>
      ...
      <div class='text-white xl:text-skin-base pl-8 w-full xl:p-3'>
    ...
    <div class="bg-skin-tertiary rounded-2xl text-skin-base xl:col-start-2 xl:col-end-6 xl:row-start-1 xl:row-end-2 xl:ml-5 xl:mb-5">
    ...
    <div class="bg-skin-tertiary rounded-2xl text-skin-base xl:col-start-2 xl:col-end-6 xl:row-start-2 xl:row-end-3 xl:bg-primary xl:ml-5 xl:p-3.5">
      <div class='pt-8'>
