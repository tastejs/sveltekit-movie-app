...
<section id="episode">
	<div class="max-w-7xl mx-auto text-skin-base xl:mt-5 xl:mb-10 bg-skin-secondary xl:pl-5 pt-1 pb-1 xl:rounded-2xl">
		{#if episode_details.id}
			<h4 class="pb-2">Episode Information</h4>
			<div class=" bg-skin-primary flex flex-col xl:flex-row m-4 p-2 rounded-lg">
				<img class="flex xl:w-80 xl:h-44 items-start"
				...
				<div>
					...
					<div class="text-skin-base flex flex-wrap justify-center sm:justify-start sm:flex-nowrap sm:overflow-y-hidden relative">
						{#each episode_details.guest_stars as guest_star}
							<div class="w-40 h-72 flex-shrink-0 rounded mb-2 relative bg-secondary m-0.5 sm:mr-3 hover:bg-selected">
