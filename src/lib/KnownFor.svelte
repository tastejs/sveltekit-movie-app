        ...
        {#each films as movie}
          <div class='w-28 h-56 flex-shrink-0 rounded mb-2 relative bg-secondary m-0.5 sm:mr-3 hover:bg-selected'>
            <a class='rounded w-28' href={`/movie/${movie.id}`}>
              <img class='object-cover w-28 h-44 rounded-t' src={movie.poster_path ? IMAGE_API + movie.poster_path : '/default.jpg' } alt={movie.title} />
        ...
        {#each tv as show}
          <div class='w-28 h-56 flex-shrink-0 rounded mb-2 relative bg-secondary m-0.5 sm:mr-3 hover:bg-selected'>
            <a class='rounded w-28' href={`/tv/${show.id}`}>
              <img class='object-cover w-28 h-44 rounded-t'src={show.poster_path ? IMAGE_API + show.poster_path : '/default.jpg' } alt={show.name} />
              <div class="w-28 h-12 p-0.5">
