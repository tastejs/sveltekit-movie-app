...
const manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      params: empty,
      load: () => import("./getMovieGenres-3625ddfd.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getTvNetworks\/?$/,
      params: empty,
      load: () => import("./getTvNetworks-3869faf2.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getShowGenre\/?$/,
      params: empty,
      load: () => import("./getShowGenre-bece8541.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getKnownFor\/?$/,
      params: empty,
      load: () => import("./getKnownFor-737a4ce8.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getTvGenres\/?$/,
      params: empty,
      load: () => import("./getTvGenres-8924ea77.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getEpisode\/?$/,
      params: empty,
      load: () => import("./getEpisode-3741fea8.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getTrailer\/?$/,
      params: empty,
      load: () => import("./getTrailer-b36b5a94.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getPerson\/?$/,
      params: empty,
      load: () => import("./getPerson-73622a35.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getSearch\/?$/,
      params: empty,
      load: () => import("./getSearch-b70547a7.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getSeason\/?$/,
      params: empty,
      load: () => import("./getSeason-d3cb4046.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getMovie\/?$/,
      params: empty,
      load: () => import("./getMovie-dfbada3a.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getCast\/?$/,
      params: empty,
      load: () => import("./getCast-7cf0533a.js")
    },
    {
      type: "endpoint",
      pattern: /^\/api\/getShow\/?$/,
      params: empty,
      load: () => import("./getShow-6a79cddc.js")
    },
    {
      type: "page",
      pattern: /^\/tv\/([^/]+?)\/?$/,
...
const module_lookup = {
  "src/routes/__layout.svelte": () => import("./__layout-9a9c760a.js"),
  "src/routes/__error.svelte": () => import("./__error-747195c4.js"),
  "src/routes/index.svelte": () => import("./index-e924169f.js"),
  "src/routes/NotFound.svelte": () => import("./NotFound-b849d5e8.js"),
  "src/routes/networks.svelte": () => import("./networks-ae2e9ad7.js"),
  "src/routes/trending/[media].svelte": () => import("./[media]-a81ee0de.js"),
  "src/routes/episode/[id]/[season_number]/[episode_number].svelte": () => import("./[episode_number]-d506294b.js"),
  "src/routes/network/[id].svelte": () => import("./[id]-90071bec.js"),
  "src/routes/seasons/[id]/[season_number].svelte": () => import("./[season_number]-5bfe966f.js"),
  "src/routes/person/[id].svelte": () => import("./[id]-25ddb610.js"),
  "src/routes/search/[id].svelte": () => import("./[id]-8719dbcf.js"),
  "src/routes/genre/movies/[id].svelte": () => import("./[id]-f5f0ab76.js"),
  "src/routes/genre/tvs/[id].svelte": () => import("./[id]-249790d4.js"),
  "src/routes/genre/[media]/[id].svelte": () => import("./[id]-8e5400b3.js"),
  "src/routes/movie/[id].svelte": () => import("./[id]-69ae2200.js"),
  "src/routes/tv/[id].svelte": () => import("./[id]-0af00fc5.js")
};
...
export { add_attribute as a, escape as b, create_ssr_component as c, set_store_value as d, each as e, safe_not_equal as f, get_store_value as g, createEventDispatcher as h, getContext as i, init as j, noop as n, onDestroy as o, render as r, subscribe as s, validate_component as v };
