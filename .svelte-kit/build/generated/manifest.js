const c = [
	...
	() => import("..\\..\\..\\src\\routes\\genre\\tvs\\[id].svelte"),
...
export const routes = [
	...
	// src/routes/network/[id].svelte
	[/^\/network\/([^/]+?)\/?$/, [c[0], c[7]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/seasons/[id]/[season_number].svelte
	[/^\/seasons\/([^/]+?)\/([^/]+?)\/?$/, [c[0], c[8]], [c[1]], (m) => ({ id: d(m[1]), season_number: d(m[2])})],

	// src/routes/person/[id].svelte
	[/^\/person\/([^/]+?)\/?$/, [c[0], c[9]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/search/[id].svelte
	[/^\/search\/([^/]+?)\/?$/, [c[0], c[10]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/genre/movies/[id].svelte
	[/^\/genre\/movies\/([^/]+?)\/?$/, [c[0], c[11]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/genre/tvs/[id].svelte
	[/^\/genre\/tvs\/([^/]+?)\/?$/, [c[0], c[12]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/genre/[media]/[id].svelte
	[/^\/genre\/([^/]+?)\/([^/]+?)\/?$/, [c[0], c[13]], [c[1]], (m) => ({ media: d(m[1]), id: d(m[2])})],

	// src/routes/movie/[id].svelte
	[/^\/movie\/([^/]+?)\/?$/, [c[0], c[14]], [c[1]], (m) => ({ id: d(m[1])})],
