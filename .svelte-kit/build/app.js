...
const module_lookup = {
	...
	'src/routes/__error.svelte': () => import('..\\..\\src\\routes\\__error.svelte'),
	'src/routes/index.svelte': () => import('..\\..\\src\\routes\\index.svelte'),
	'src/routes/NotFound.svelte': () => import('..\\..\\src\\routes\\NotFound.svelte'),
	'src/routes/episode/[id]/[season_number]/[episode_number].svelte': () =>
	...
	'src/routes/person/[id].svelte': () => import('..\\..\\src\\routes\\person\\[id].svelte'),
	'src/routes/search/[id].svelte': () => import('..\\..\\src\\routes\\search\\[id].svelte'),
	'src/routes/genre/movie/[id].svelte': () =>
		import('..\\..\\src\\routes\\genre\\movie\\[id].svelte'),
	'src/routes/genre/tv/[id].svelte': () => import('..\\..\\src\\routes\\genre\\tv\\[id].svelte'),
	'src/routes/movie/[id].svelte': () => import('..\\..\\src\\routes\\movie\\[id].svelte'),
	'src/routes/tv/[id].svelte': () => import('..\\..\\src\\routes\\tv\\[id].svelte')
};
